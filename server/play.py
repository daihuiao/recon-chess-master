...
import datetime
# https://github1s.com/misorashed/ReconChessBSP
...
def main():
    ...
    parser.add_argument('--bot_path', default=r"E:\360MoveData\Users\dell\Desktop\finalefinalehomework\useless\recon-chess-master\server\Chessnut.py",help='Path to bot source file.')
    parser.add_argument('--color', default='black', choices=['white', 'black', 'random'],
