...
def main():
    ...
    parser.add_argument('--history_path',default=r"E:\360MoveData\Users\dell\Desktop\finalefinalehomework\useless\recon-chess-master\server\Chessnut-Human-black-2022_05_01-20_46_36.json", help='Path to saved Game History file.')
